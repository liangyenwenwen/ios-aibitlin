...
//            popoverPresentationController?.popoverBackgroundViewClass = CustomCollectionViewPopoverBackgroundView.self
            ...
            if let sender {
                ...
                //set a sourceRect which is guranteed to be inside the device bounds when the senderView exceeds the devie bounds
