...
extension UIViewController {
    public func presentAlert(useRoot: Bool = true, title: String? = nil, cancelTitle: String? = "cancel".innerLocalized(), confirmHandler: (() -> Void)? = nil) {
        ...
        if let confirmHandler {
            alertController.addAction(AlertAction(title: "determine".innerLocalized(), style: .default, handler: { [weak self] _ in
                confirmHandler()
            }))
        }
