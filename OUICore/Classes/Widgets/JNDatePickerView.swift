...
open class JNDatePickerView: UIView {
    ...
    static public func show(onWindowOfView: UIView, currentDate: Date = Date(), configure: ((JNDatePickerView) -> Void)?, confirmAction: @escaping ((Date) -> Void)) {
