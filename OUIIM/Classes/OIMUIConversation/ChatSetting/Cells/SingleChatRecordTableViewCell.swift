...
class SingleChatRecordTableViewCell: UITableViewCell {
    ...
    public let searchTextBtn: UpImageButton = {
        let v = UpImageButton()
    ...
    public let searchImageBtn: UpImageButton = {
        let v = UpImageButton()
    ...
    public let searchVideoBtn: UpImageButton = {
        let v = UpImageButton()
    ...
    public let searchFileBtn: UpImageButton = {
        let v = UpImageButton()
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let hStack: UIStackView = {
            let v = UIStackView(arrangedSubviews: [searchTextBtn, UIView(), searchImageBtn, UIView(), searchVideoBtn, UIView(), searchFileBtn])
