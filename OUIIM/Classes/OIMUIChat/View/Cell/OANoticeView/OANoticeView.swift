...
final class OANoticeView: UIView, ContainerCollectionViewCellDelegate {
    ...
    private func setupSubviews() {
        ...
        NSLayoutConstraint.activate([
            stackView.topAnchor.constraint(equalTo: layoutMarginsGuide.topAnchor, constant: 1),
            stackView.bottomAnchor.constraint(equalTo: layoutMarginsGuide.bottomAnchor, constant: -1),
            stackView.leadingAnchor.constraint(equalTo: layoutMarginsGuide.leadingAnchor, constant: 1),
            stackView.trailingAnchor.constraint(equalTo: layoutMarginsGuide.trailingAnchor, constant: -1),
        ])
    ...
    private func setupSize() {
        ...
        imageHeightConstraint?.constant = controller.source.height ?? 40
