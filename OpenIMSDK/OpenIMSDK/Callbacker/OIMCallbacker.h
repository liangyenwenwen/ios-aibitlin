...
typedef void (^OIMGroupReceiptCallback)(OIMGroupMessageReceipt * _Nullable msgReceiptList);
 ...
 */
- (void)onRecvGroupReadReceipt:(OIMGroupMessageReceipt *)groupMsgReceiptList;
...
@property (nonatomic, nullable, copy) OIMGroupReceiptCallback onRecvGroupReadReceipt;
