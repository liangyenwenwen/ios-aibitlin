...
@implementation OIMGroupMessageReadInfo

+ (NSDictionary *)mj_objectClassInArray
{
    return @{@"readMembers" : [OIMGroupMemberInfo class]};
}

@end

@implementation OIMGroupMessageReceipt

+ (NSDictionary *)mj_objectClassInArray
{
    return @{@"groupMessageReadInfo" : [OIMGroupMessageReadInfo class]};
}
