...
@interface OIMGroupMessageReadInfo : NSObject

@property (nonatomic, copy) NSArray<OIMGroupMemberInfo *> *readMembers;
...
@interface OIMGroupMessageReceipt : NSObject

@property (nonatomic, copy) NSString *conversationID;
@property (nonatomic, copy) NSArray<OIMGroupMessageReadInfo *> *groupMessageReadInfo;
