...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LiveKitClient-iOS13.0/LiveKitClient.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Localize-Swift/Localize_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Logging-iOS13.0/Logging.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PromisesSwift-iOS13.0/Promises.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftProtobuf-iOS13.0/SwiftProtobuf.framework"
