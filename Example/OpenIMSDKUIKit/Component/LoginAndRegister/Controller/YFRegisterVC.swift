...
//        superHeaderContainerContainer.tg_height.equal(50)
    ...
    lazy var appTitleLbl: UILabel = {
        let r = ViewFactoryUtil.customBoldTilteLable("注册688".localized(), font: TEXT_LARGE4, textColor: .black333)
        r.tg_top.equal(84)
        return r
    }()
...
//    }()
    ...
    lazy var agreementView: BSLabel = {
        ...
        let agreementString = "我已阅读并同意688《注册协议》".localized()
...
//        
        ...
        var range1 = agreementString.range(of: "我已阅读并同意688《注册协议》".localized())!
