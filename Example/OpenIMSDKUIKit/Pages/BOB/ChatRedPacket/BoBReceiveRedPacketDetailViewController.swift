...
class BoBReceiveRedPacketDetailViewController: BaseTitleController {
    var listArray:[String] = ["荷包蛋小朋友","詹尼佛","荷包蛋小朋友","詹尼佛","荷包蛋小朋友","詹尼佛","荷包蛋小朋友","詹尼佛","荷包蛋小朋友","詹尼佛"]
...
extension BoBReceiveRedPacketDetailViewController{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       let item = listArray[indexPath.row]
        ...
        cell.userImageView.sd_setImage(with: URL(string: "http://192.168.7.126:10002/object/6150535698/image_2024-12-06-15-54.544.png"))
        cell.userNameLabel.text = item
        cell.timeLabel.text = "15:30"
        cell.moneyLabel.text = "4.25 C"
        if indexPath.row == 3{
            cell.bestLabel.show()
            cell.bestLabel.text = "手气最佳"
        }else{
            cell.bestLabel.hide()
        }
