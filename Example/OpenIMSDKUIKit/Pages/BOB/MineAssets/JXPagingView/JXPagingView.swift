...
//                //frame可以先计算完成  避免圆角拉伸
//        let rect = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width - 32, height: max(bounds.height - pinSectionHeaderHeight() - CGFloat(pinSectionHeaderVerticalOffset), 0))
