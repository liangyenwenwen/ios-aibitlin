...
//    }
    ...
    func swizzleMethod() {
        ...
        //reload
        let originalSelector4 = #selector(UITableView.reloadData as (UITableView) -> () -> Void)
...
extension UICollectionView:SelfAware {
    ...
    private static let swizzleMethod: Void = {
        ...
        //reload
        let originalSelector4 = #selector(UICollectionView.reloadData as (UICollectionView) -> () -> Void)
        let swizzledSelector4 = #selector(ly_reloadData)
