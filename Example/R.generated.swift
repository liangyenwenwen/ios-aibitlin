...
struct _R: Sendable {
  ...
  struct image {
    ...
    /// Image `mine_bill_choose_icon`.
    var mine_bill_choose_icon: RswiftResources.ImageResource { .init(name: "mine_bill_choose_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `mine_bill_date_icon`.
    var mine_bill_date_icon: RswiftResources.ImageResource { .init(name: "mine_bill_date_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `mine_buy_and_sell_buy_money_icon`.
    var mine_buy_and_sell_buy_money_icon: RswiftResources.ImageResource { .init(name: "mine_buy_and_sell_buy_money_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `mine_buy_and_sell_buy_type_icon`.
    var mine_buy_and_sell_buy_type_icon: RswiftResources.ImageResource { .init(name: "mine_buy_and_sell_buy_type_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `mine_home_cion_c_icon`.
    var mine_home_cion_c_icon: RswiftResources.ImageResource { .init(name: "mine_home_cion_c_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `mine_red_packet_detail_top_icon`.
    var mine_red_packet_detail_top_icon: RswiftResources.ImageResource { .init(name: "mine_red_packet_detail_top_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `mine_red_packet_log_icon`.
    var mine_red_packet_log_icon: RswiftResources.ImageResource { .init(name: "mine_red_packet_log_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `mine_red_packet_recieve_bg_icon`.
    var mine_red_packet_recieve_bg_icon: RswiftResources.ImageResource { .init(name: "mine_red_packet_recieve_bg_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `mine_red_packet_recieve_close_icon`.
    var mine_red_packet_recieve_close_icon: RswiftResources.ImageResource { .init(name: "mine_red_packet_recieve_close_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `order_stytem_message_open_icon`.
    var order_stytem_message_open_icon: RswiftResources.ImageResource { .init(name: "order_stytem_message_open_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `quick_buy_or_sell_error_icon`.
    var quick_buy_or_sell_error_icon: RswiftResources.ImageResource { .init(name: "quick_buy_or_sell_error_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `receive_payment_copy_icon`.
    var receive_payment_copy_icon: RswiftResources.ImageResource { .init(name: "receive_payment_copy_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
